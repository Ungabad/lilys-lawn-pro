export default function ServiceAreaSection() {
  return (
    <section className='py-16 bg-[#707c72] text-white'>
      <div className='container mx-auto px-4 md:px-6'>
        <div className='flex flex-col lg:flex-row items-center gap-8'>
          <div className='lg:w-1/2'>
            ...
            <a
              href='#contact'
              className='inline-block mt-4 bg-primary text-dark px-6 py-3 rounded-md font-medium hover:bg-opacity-90 transition duration-200'
            >
              Contact Us
            </a>
          </div>
