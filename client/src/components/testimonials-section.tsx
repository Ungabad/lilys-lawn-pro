...
const testimonials = [
  {
    text: "Lily's Lawn & Snow Pros have been taking care of our property for over a year now, and I couldn't be happier with their service. The lawn looks immaculate, and their snow removal service was a lifesaver during last winter's storms.",
    name: "John D.",
    location: "Spokane Valley",
    initials: "JD"
  },
  {
    text: "We hired Lily's for our commercial property maintenance, and they've exceeded our expectations. Their team is reliable, professional, and thorough. Our business entrance always looks inviting thanks to them.",
    name: "Sarah M.",
    location: "Business Owner, North Spokane",
    initials: "SM"
  },
  {
  ...
  {
    text: "I can't say enough good things about this company. They're always on time, do excellent work, and their prices are fair. Their snow removal service is particularly impressive - we never have to worry about getting snowed in.",
    name: "Amanda W.",
    location: "Mead",
    initials: "AW"
  }
  ...
  const scrollToTestimonial = (index: number) => {
    if (sliderRef.current && sliderRef.current.children[index]) {
      sliderRef.current.scrollTo({
        left: (sliderRef.current.children[index] as HTMLElement).offsetLeft - sliderRef.current.offsetLeft,
        behavior: 'smooth'
      });
