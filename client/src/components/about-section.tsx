      ...
      <div className='container mx-auto px-4 md:px-6'>
        <div className='flex flex-col md:flex-row gap-8 items-center'>
          <div className='md:w-1/2'>
            <img
              src='https://media.istockphoto.com/id/154099460/photo/mowing-the-grass.jpg?b=1&s=612x612&w=0&k=20&c=NQqQeHik9O8rACyABG8aFaavE39uYlrfK_lvGckPytY='
          ...
          <div className='md:w-1/2'>
            ...
            <p className='mb-6 text-dark'>
              ...
              highest standards of quality and customer satisfaction. Our team
              of experienced professionals is dedicated to keeping your property
