        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='prose prose-gray max-w-none'>
            ...
            <section className='mb-8'>
              ...
              <p>
                By accessing and using the services provided by Lily's Lawn &
                Snow Pro's LLC, you agree to be bound by these Terms of Service.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p>
                We provide lawn care and snow removal services including but not
                limited to:
              </p>
            ...
            <section className='mb-8'>
              ...
              <p>
                We require 24-hour notice for service cancellations. Late
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 mb-4'>
                ...
                <li>
                  Maintaining clear communication about service requirements
                </li>
              </ul>
            </section>
